...
public class MainActivity extends AppCompatActivity {
    ...
    private void recyclerViewPopular(){
        ...
        foodList.add(new FoodDomain("Pepperoni pizza","pop_1","slices pepperoni , mozzerella cheese,fresh orange,ground black pepper, ground black pepper,pizza sauce",9.76));
        foodList.add(new FoodDomain("Cheese Burger","pop_2","beef , gouda Cheese, Special Sauce, Lettuce,tomato",8.79));
        foodList.add(new FoodDomain("Vegetable","pop_3","olive oil, vegetable oil,pitted kalamata,cherry, fresh oregano, basil",8.5));
